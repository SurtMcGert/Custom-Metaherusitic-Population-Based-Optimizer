...
class NSGAOptimizer(torch.optim.Optimizer):
    # Init Method:
    def __init__(self, device, model, lossFn, pop=20):
        params = model.last_layer.parameters()
        super(NSGAOptimizer, self).__init__(params, defaults={'pop': pop})
        ...
        self.loss = {}  # a dictionary to store the fitnesses
        self.gaussianReg = {}  # a dictionary to store the gaussian regulariaser
